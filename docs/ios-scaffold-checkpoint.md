...
- Help / Data Sources is written as user-facing product help and reflects the current album workflow, Producer Search guidance, source roles, Wikidata/Wikipedia behavior, missing-credit expectations, support contact, concise privacy/network data notes, source affiliation disclaimers, and trust rules.
