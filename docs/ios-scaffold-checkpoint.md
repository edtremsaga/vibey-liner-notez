...
- Help / Data Sources is written as concise user-facing product help and reflects the current album workflow, Producer Search guidance, source roles, Wikidata/Wikipedia behavior, missing-credit expectations, support contact, privacy/network data notes, source affiliation disclaimers, and trust rules.
